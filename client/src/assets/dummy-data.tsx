...
export const featuresData = [
    {
        ...
        title: 'Smart Upload',
        desc: 'Drag & drop your assets. We auto-optimize formates and sizes.'
    },
    {
...
export const faqData = [
    ...
    },
    {
        ...
        answer: 'Yes, you can cancel from you dashboard. You will retain access through the end of your billing cycle.'
    },
    {
        question: 'What input formats do you support?',
        answer: 'We accepts JPG, PNG and WEBP files. For best results, use high-resolution images with clear backgrounds.'
    }
];
...
export const footerLinks = [
    ...
    },
    {
        ...
        links: [
            { name: "Twitter", url: "#" },
            { name: "LinkedIn", url: "#" },
            { name: "GitHub", url: "https://github.com/kartik-singhhh03" }
        ]
    }
];