      ...
      >
        {file ? (
          <>
            ...
            />
            <div className="absolute inset-0 flex items-center justify-center opacity-9 group-hover:opacity-100 transition-opacity bg-black/40 rounded-xl backdrop-blur-sm">
              <button
                type="button"
                onClick={onClear}
